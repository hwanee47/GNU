CREATE MEMORY TABLE MEMBER(ID VARCHAR(20) NOT NULL PRIMARY KEY,PASSWORD VARCHAR(100) NOT NULL,NAME VARCHAR(20), AUTH VARCHAR(20))
...
SET WRITE_DELAY 20
SET SCHEMA PUBLIC
INSERT INTO MEMBER VALUES ('admin','admin', 'hwanee', 'ADMIN')
INSERT INTO MEMBER VALUES ('admin2','admin2', 'hwanee', 'ADMIN')
INSERT INTO MEMBER VALUES ('admin3','admin3', 'hwanee', 'ADMIN')
