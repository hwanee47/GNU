         ...
         <form class="form-status">
            ...
            <table class="table table-striped table-condensed">
             ...
             <c:forEach var="groupList" items="${groupList}">
                 ...
                 <tr>
                    <th style="border-top-width: 0px;border-bottom-width: 0px;">${groupList.DONG}동</th>
                    <th style="border-top-width: 0px;border-bottom-width: 0px;">${groupList.FLOOR}층</th>
                 </tr>
                 </thead>
                   <c:forEach var="nowStatusList" items="${nowStatusList}">
                      ...
                      <tbody>
                        ...
                        <c:if test="${nowStatusList.PART2 eq 'N'}">
                           <span class="label label-danger">칸2</span>
                        </c:if>
                        <c:if test="${nowStatusList.PART2 eq 'Y'}">
                           <span class="label label-success">칸2</span>
                        </c:if>
                     </td>
                            <td style="padding-top: 8px;">
                        <c:if test="${nowStatusList.PART3 eq 'N'}">
                           <span class="label label-danger">칸3</span>
                        </c:if>
                        <c:if test="${nowStatusList.PART3 eq 'Y'}">
                           <span class="label label-success">칸3</span>
                        </c:if>
                     </td>
